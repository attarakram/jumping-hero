...
# soundtrack boss fight
slime_boss_soundtrack = pygame.mixer.Sound('../audio/slime_boss_soundtrack.ogg')
worm_boss_soundtrack = pygame.mixer.Sound('../audio/worm_boss_soundtrack.ogg')
boss_soundtrack = pygame.mixer.Sound('../audio/boss_soundtrack.ogg')
